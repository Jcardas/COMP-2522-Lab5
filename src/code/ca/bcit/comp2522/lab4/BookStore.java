...
public class BookStore
{
     ...
     */
    public boolean isThereABookWritenIn(final int year)
    {
        boolean result;
    ...
    public int howManyBooksContain(final String word)
    {
        ...
        for(final Novel novel : novels)
        {
            if(novel != null && novel.getTitle().toLowerCase().contains(word.toLowerCase()))
            {
                result++;
            }
        }
     ...
     */
    public double whichPrecentWittenBetween(final int first, final int last)
    {
        int result;
    ...
    public List getBooksThisLength(int titleLength)
    {
        ...
        for(final Novel novel : novels)
        {
            if(novel != null && novel.getTitle().length() == titleLength)
            {
    ...
    {
        // TODO fix the errors in the main copied from the lab
...
//TODO I don't know if these should be in the constructor or the main method
